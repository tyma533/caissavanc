...
public class EtatOperation implements Serializable {
    ...
    public EtatOperation id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public EtatOperation dateHeureModification(Instant dateHeureModification) {
    ...
    public EtatOperation dateHeureCreation(Instant dateHeureCreation) {
    ...
    public EtatOperation utiCree(Long utiCree) {
    ...
    public EtatOperation utiModifie(Long utiModifie) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((EtatOperation) o).getId());
    }
