...
/**
 * A DTO for the {@link com.mycompany.myapp.domain.ModeOperation} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ModeOperationDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModeOperationDTO)) {
            return false;
        }

        ModeOperationDTO modeOperationDTO = (ModeOperationDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, modeOperationDTO.id);
    }
