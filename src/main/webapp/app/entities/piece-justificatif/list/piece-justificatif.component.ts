...
import { EntityArrayResponseType, PieceJustificatifService } from '../service/piece-justificatif.service';
import { PieceJustificatifDeleteDialogComponent } from '../delete/piece-justificatif-delete-dialog.component';
...
export class PieceJustificatifComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPieceJustificatif): number => this.pieceJustificatifService.getPieceJustificatifIdentifier(item);
  ...
  delete(pieceJustificatif: IPieceJustificatif): void {
    const modalRef = this.modalService.open(PieceJustificatifDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.pieceJustificatif = pieceJustificatif;
  ...
  protected fillComponentAttributesFromResponseBody(data: IPieceJustificatif[] | null): IPieceJustificatif[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.pieceJustificatifService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
