...
import { EntityArrayResponseType, EtatOperationService } from '../service/etat-operation.service';
import { EtatOperationDeleteDialogComponent } from '../delete/etat-operation-delete-dialog.component';
...
export class EtatOperationComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEtatOperation): number => this.etatOperationService.getEtatOperationIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IEtatOperation[] | null): IEtatOperation[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.etatOperationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
