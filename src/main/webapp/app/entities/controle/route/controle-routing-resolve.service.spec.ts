...
import controleResolve from './controle-routing-resolve.service';

describe('Controle routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: ControleService;
  let resultControle: IControle | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IControle returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        controleResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultControle).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IControle>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
